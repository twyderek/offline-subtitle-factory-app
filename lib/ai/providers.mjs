...
import { createAnthropicMessage, listAnthropicModels, testAnthropic } from './anthropic.mjs';
...
export const PROVIDER_CAPABILITIES = Object.freeze({
  ...
  anthropic: { jsonSchema: false, streaming: false, modelList: true, localEndpoint: false },
...
const adapters = {
  ...
  anthropic: {
    ...
    optimize: createAnthropicMessage,
  },
};
