...
try {
  ...
  if (!['openai', 'openai-compatible', 'azure', 'groq', 'gemini', 'anthropic', 'ollama', 'lm-studio'].every((id) => result.aiReviewAssets.providerIds.includes(id))) throw new Error('Packaged provider definitions are incomplete');
  if (trimMediaPath) {
